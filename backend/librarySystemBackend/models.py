...
class User(AbstractUser):
    ...
    REQUIRED_FIELDS = ['username'] # username is required by AbstractUser createsuperuser
...
class Reservation(models.Model):
    ...
    book = models.ForeignKey(Book, on_delete=models.CASCADE, related_name='all_reservations')
...
class Loan(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                fields=['user', 'book'],
                condition=models.Q(status__in=['active', 'pending_transfer', 'overdue']),
...
class TransferRequest(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    loan = models.ForeignKey(Loan, on_delete=models.CASCADE, related_name='transfer_requests')
